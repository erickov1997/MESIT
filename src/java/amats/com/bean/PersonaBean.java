...
public class PersonaBean implements Serializable {
    ...
    public void exportarPDF(ActionEvent actionEvent) throws JRException, IOException, ClassNotFoundException {
        ...
        File jasper = new File(FacesContext.getCurrentInstance().getExternalContext().getRealPath("/reportes/MesItAactual.jasper"));
...
//    
    ...
    public void exportarDOC(ActionEvent actionEvent) throws JRException, IOException, ClassNotFoundException {
        DBHandler handler = new DBHandler();
        handler.getConnection();
